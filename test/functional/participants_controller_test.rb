  ...
  context "#school_name" do
    context "on create" do
      should "save existing school name" do
        post :create, participant: { city: @participant.city, email: @participant.email, experience: @participant.experience, first_name: @participant.first_name, interest: @participant.interest, last_name: @participant.last_name, state: @participant.state, year: @participant.year, school_name: @school.name }
        assert_redirected_to participant_path(assigns(:participant))
        assert_equal 1, School.all.count
      end

      should "create a new school when unknown" do
        post :create, participant: { city: @participant.city, email: @participant.email, experience: @participant.experience, first_name: @participant.first_name, interest: @participant.interest, last_name: @participant.last_name, state: @participant.state, year: @participant.year, school_name: "New School" }
        assert_redirected_to participant_path(assigns(:participant))
